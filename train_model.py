...
Original file is located at
    https://colab.research.google.com/drive/1zUzEd9JmZwNyLmIfWHvfaDEC3kgUmfhq
"""
...
# %cd /content/drive/MyDrive/Aurum AI ML
...
def default_q():
    return np.zeros(len(df_encoded["Subcontractor_Name"].unique()))
